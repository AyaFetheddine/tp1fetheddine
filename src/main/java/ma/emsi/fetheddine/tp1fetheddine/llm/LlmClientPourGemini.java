...
public class LlmClientPourGemini implements Serializable {
    ...
    public LlmClientPourGemini() {
        ...
        String sysPropKey = System.getProperty("GEMINI_KEY");
        this.key = (envKey != null && !envKey.isBlank()) ? envKey : sysPropKey;
     ...
     */
    public Response envoyerRequete(Entity<String> requestEntity) throws RequeteException {
